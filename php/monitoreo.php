...
try{
	...
	if ((isset($_GET['t1m1']))&&(isset($_GET['t1m2']))&&(isset($_GET['t1n']))){
		...
		echo 'Debe ingresar todos los datos del tanque 1.<br>';
	}
	...
	if ((isset($_GET['t2m1']))&&(isset($_GET['t2m2']))&&(isset($_GET['t2n']))){
		...
		echo 'Debe ingresar todos los datos del tanque 2.<br>';
	}
	...
	if (isset($_GET['t3n'])){		
		...
		echo 'Debe ingresar todos los datos del tanque 3.<br>';
	}
}catch(Exception $e){
	echo $e->getMessage();
}
